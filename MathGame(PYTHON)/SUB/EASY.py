...
def easy():
    ...
    NAME=input("\nType Your Name:")
    print("GOODLUCK",NAME)
    print("The difficulty of the game is EASY")
    ...
    for q,a in questions:
        ...
        if correct_answer == a:
            ...
            print("\n",q,"[","Incorrect","]","[","The actual answer is",correct_answer,"]")
            W+=1
    P=int((C/Q)*100)
    print("\n-------------------------------------FINAL RESULTS---------------------------------------")
    print("\nYour name is",NAME)
    ...
    Insert=("INSERT INTO custom_game(Name, CORRECT_questions, TOTAL_questions, PERCENTAGE, LEVEL) VALUES (%s,%s,%s,%s,'EASY')")
    val=NAME, C, Q, P
